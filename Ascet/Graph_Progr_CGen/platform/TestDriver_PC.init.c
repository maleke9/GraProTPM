...
static void initClass_ROOT_TestDriver_PC(ROOT_TestDriver_PC_Class *self)
{
    self->ASCET_TOP_Ptr = (struct L1_TestDriver_PC_Obj*) initInstance_L1_TestDriver_PC();
}
...
static ASDClassHeader ROOT_ClassHeader_TestDriver_PC = {0, 0, 0, 1, (MethodList *)0, (MethodList *)0};
static ROOT_TestDriver_PC_Class ROOT_TestDriver_PC_ClassObj = {{1, {&ROOT_ClassHeader_TestDriver_PC}, {0}}};

/**
 * Initialization of model 
 **/

ASDObject *initializeRoot_TestDriver_PC(void)
{
    struct ROOT_TestDriver_PC_Obj *self = 0;

    initClass_ROOT_TestDriver_PC(&ROOT_TestDriver_PC_ClassObj);
    CREATE_OBJECT(self, ROOT_TestDriver_PC);
...
{
    return initializeRoot_TestDriver_PC();
}
