 ...
 * ---------------------------------------------------------------------------*/
const volatile struct components_lib_diffCheck_Automatic_CAL_MEM_SUBSTRUCT components_lib_diffCheck_CAL_MEM = {
...
{
   return (((arg > 0.0F) ? arg : -arg)) >= components_lib_diffCheck_CAL_MEM.border;
}
/* ----------------------------------------------------------------------------
