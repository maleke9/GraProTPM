...
static void initClass_ROOT_IntegratorTest_PC(ROOT_IntegratorTest_PC_Class *self)
{
    self->ASCET_TOP_Ptr = (struct L1_IntegratorTest_PC_Obj*) initInstance_L1_IntegratorTest_PC();
}
...
static ASDClassHeader ROOT_ClassHeader_IntegratorTest_PC = {0, 0, 0, 1, (MethodList *)0, (MethodList *)0};
static ROOT_IntegratorTest_PC_Class ROOT_IntegratorTest_PC_ClassObj = {{1, {&ROOT_ClassHeader_IntegratorTest_PC}, {0}}};

/**
 * Initialization of model 
 **/

ASDObject *initializeRoot_IntegratorTest_PC(void)
{
    struct ROOT_IntegratorTest_PC_Obj *self = 0;

    initClass_ROOT_IntegratorTest_PC(&ROOT_IntegratorTest_PC_ClassObj);
    CREATE_OBJECT(self, ROOT_IntegratorTest_PC);
...
{
    return initializeRoot_IntegratorTest_PC();
}
